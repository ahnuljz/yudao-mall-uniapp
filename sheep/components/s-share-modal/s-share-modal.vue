...
<template>
  <view>
    ...
    <view v-if="state.showShareGuide" class="guide-wrap">
      <image class="guide-image" :src="sheep.$url.cdn('/img/share_guide.png')" />
    </view>
    ...
    <su-popup :show="show" round="10" :showClose="false" @close="closeShareModal">
      ...
      <view class="share-box">
        <view class="share-list-box ss-flex">
          ...
          >
            <image class="share-img" :src="sheep.$url.cdn('/img/share_wx.png')" mode="" />
          ...
          <button
            ...
            @tap="onShareByPoster"
          >
            <image class="share-img" :src="sheep.$url.cdn('/img/share_poster.png')" mode="" />
          ...
          >
            <image class="share-img" :src="sheep.$url.cdn('/img/share_link.png')" mode="" />
