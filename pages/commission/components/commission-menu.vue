...
<template>
  <view class="menu-box ss-flex-col">
    <view class="header-box">
      <image class="header-bg" :src="sheep.$url.cdn('/img/title1.png')" />
    ...
    <view class="menu-list ss-flex ss-flex-wrap">
      ...
      >
        <image class="menu-icon ss-m-b-10" :src="sheep.$url.cdn(item.img)" mode="aspectFill"></image>
...
<script setup>
  ...
  const state = reactive({
    menuList: [
      {
        img: '/img/commission_icon1.png',
        title: '我的团队',
        path: '/pages/commission/team',
      },
      {
        img: '/img/commission_icon2.png',
        title: '佣金明细',
        path: '/pages/commission/wallet',
      },
      {
        img: '/img/commission_icon3.png',
        title: '分销订单',
        path: '/pages/commission/order',
      },
      {
        img: '/img/commission_icon4.png',
        title: '推广商品',
